  ...
  return (
    <View style={styles.container}>
      <Text style={{ textAlign: "left", fontSize: 20 }}>
        - KÄNNER DU ATT DU INTE HAR NÅGON ATT PRATA ELLER VARA MED?
      </Text>
      ...
      <Text style={{ textAlign: "left", fontSize: 20 }}>
        - KÄNNER DU DIG PIGG OCH LEKFULL?
      </Text>
      <View style={styles.answerContainer}>
        <TouchableOpacity
      ...
      <Text style={{ textAlign: "left", fontSize: 20 }}>
        - HAR NÅGON LOVAT NÅGOT SOM DOM INTE HÅLLIT?
      </Text>
      <View style={styles.answerContainer}>
        <TouchableOpacity
      ...
      <Text style={{ textAlign: "left", fontSize: 20 }}>
        - HAR DU ONT I MAGEN OCH SVÅRT ATT SITTA STILL?
      </Text>
      <View style={styles.answerContainer}>
        <TouchableOpacity
      ...
      <View style={styles.answerContainer}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate("EmoGameQ5")
          }
        >
